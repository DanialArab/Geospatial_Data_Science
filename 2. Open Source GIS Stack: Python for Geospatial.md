...
Then I need to get Lindau Chemical as the toxic release inventory site, to do so I need to extract by expression,as follows. First I'd liek to know what unique names are available in my tri layer:
...
the whole script to solve this problem is as follows:
        ...
        tribuf = processing.runAndLoadResults("native:buffer",{'INPUT':lc,'DISTANCE':804,'OUTPUT':'memory:'})['OUTPUT']
