...
Some handy stuss when working with Python Console in QGIS:
...
So, fz is a variable that references the vector layer named "Floodzones" in the current QGIS project. Once you have assigned the layer to the variable fz, you can perform various operations on this layer, such as querying, editing, or styling.
