...
The focus of this part is on the **FOSS4G** (Free and Open Source Software for Geospatial) stack. The content has 3 parts (excluding the Python review part):
...
1. [Preliminary Stuff](#1)
    1. [Software installation](#2)
        1. [QGIS (Quantum GIS)](#3)
        2. [PostgreSQL](#4)
        3. [Spatialite](#5)
        4. [Pip installing some usefull packages](#6)
            1. [psycopg2](#7)
            2. [geocoder](#8)
            3. [pypiwin32](#9)
            4. [censusgeocode](#10)
    ...
    3. [Virtual machines vs. Containers](#3)
